# Django settings for reportstar project.
import os.path
...
DATABASES = {
    'default': {
        ...
        'NAME': 'reportstar.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'kj%pa70%9gk#pi+k46p%*!uply9tf#l!3$6g@hqg*488ng2=k$'
...
ROOT_URLCONF = 'reportstar.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'reportstar.wsgi.application'
